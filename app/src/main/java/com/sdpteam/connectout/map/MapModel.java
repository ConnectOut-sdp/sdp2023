...
public class MapModel implements InterfaceMapModel {
    ...
    private void updateData() {
        ...
        testList.add(new Event("pin1", new GPSCoordinates(46.521, 6.5678), "A1"));
        testList.add(new Event("pin2", new GPSCoordinates(46.5215, 6.56785), "A2"));
        testList.add(new Event("pin3", new GPSCoordinates(46.5218, 6.5679), "A3"));
