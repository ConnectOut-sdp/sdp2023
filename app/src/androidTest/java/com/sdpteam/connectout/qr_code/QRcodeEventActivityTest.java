...
public class QRcodeEventActivityTest {
    ...
    @Rule
    public ActivityScenarioRule<QRcodeEventActivity> activityScenarioRule =
            new ActivityScenarioRule<>(QRcodeEventActivity.class);
    ...
    public void correctIntentExtraArePassed() {
        ...
        activityScenarioRule.getScenario().onActivity(activity -> {
            ...
            assertEquals("https://connect-out.com/events/0123456789", intent.getStringExtra("qrCodeData"));
        });
    }
}
